...
input = """Game 1: 2 blue, 3 red; 3 green, 3 blue, 6 red; 4 blue, 6 red; 2 green, 2 blue, 9 red; 2 red, 4 blue
...
def parse_line(line):
    ...
    for draw in individual_draws:
        ball_counts = [item.strip() for item in draw.split(",")]
    ...
    for color in ["red", "blue", "green"]:
        power *= max_counts[color]
    print("Game " + str(game) + " power: " + str(power))
