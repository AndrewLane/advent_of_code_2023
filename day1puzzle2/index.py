...
def run_process(input):
    ...
    for line in input.splitlines():
        first_number_left_to_right = find_first_number(line, True)
        first_number_right_to_left = find_first_number(line[::-1], False)
        # concatenate the two numbers
        code = first_number_left_to_right + first_number_right_to_left
        # print(f"{line} -> {code}")
        total += int(code)
    return total
